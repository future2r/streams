...
@StreamOperation(name = "JavaScript Minimum", type = TERMINAL, description = "Returns the minimum element of this stream according to the provided Comparator. Two elements are provided as 'element1' and 'element2', the result must an int stored in 'result'.")
