...
@StreamOperation(name = "JavaScript None Match", type = TERMINAL, description = "The current element is provided as 'element', the result must a boolean value stored in 'matches'.")
