...
public final class TerminalOperations {
	...
	public static final Class<? extends TerminalOperation<?>>[] IMPLEMENTATIONS = new Class[] { SystemOut.class,
			...
			StringJoiner.class, StringLengthGrouping.class, TextFileWriter.class, JavaScriptAnyMatch.class,
			JavaScriptAllMatch.class, JavaScriptNonMatch.class, JavaScriptMax.class, JavaScriptMin.class,
			JavaScriptForEach.class };
