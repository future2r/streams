...
public final class TextFileReaderConfigurationPane extends AbstractConfigurationPane<TextFileReader> {
	...
	@Override
	protected void initContent(final TextFileReader operation) {
		this.currentFile = operation.getFile();
		this.fileTextField.setText(this.currentFile.toString());
	}

	@Override
	protected boolean applyContent(final TextFileReader operation) {
