...
@StreamOperation(name = "Sleep Peek", type = INTERMEDIATE, description = "Sleeps for some time before forwarding the next element. This canm be used for debugging purposes.")
